  ...
  $(function() {
	...
	$('#SLT').click(function(){
		...
		str = str+ "<button class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal_SLT'>  Settings</button><br>";
		SLT_num++;
	...
	$('#NUM').click(function(){
		...
		str = str+ "<button class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal_NUM'>  Settings</button><br>";
		NUM_num++;
		$( "#form_holder" ).append( str );	
	});
	$('#PARAGH').click(function(){
		...
		str = str+ "<button class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal_PARAGH'>  Settings</button><br>";
		PARAGH_num++;
		$( "#form_holder" ).append( str );	
	});
	$('#CHECK').click(function(){
		...
		str = str+ "<button class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal_CHECK'>  Settings</button><br>";
	...
	$('#MCHOICE').click(function(){
		...
		str = str+ "<button class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal_MCHOICE'>  Settings</button><br>";
		MCHOICE_num++;
		$( "#form_holder" ).append( str );	
	});
	$('#DROPDN').click(function(){
		...
		str = str+ "<button class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal_DROPDN'>  Settings</button><br>";
		DROPDN_num++;
		$( "#form_holder" ).append( str );	
	});
	...
	// form settings save
	$( "body" ).on( "click", "#save_field_settings_SLT", function() {
		
		
		field_array['']
		alert($('#label').val());
		$('#SLT_1_label').html('it worked');
		$('#myModal_SLT').modal('toggle');
		});
